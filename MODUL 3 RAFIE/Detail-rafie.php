        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form class="" action="" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="nameinput" class="form-label">merek</label>
                        <input type="text" class="form-control" name="merek" id="merek" value="<?php echo $merek?>">
                    </div>
                    ...
                    <div class="mb-3">
                    <a href="Edit-rafie.php?op=edit&id=<?php echo $id_mobil?>" class="btn btn-primary">Edit</a>
                    </div>
                </div>
                </form>
